...
abstract: In a multi-armed bandit (MAB) problem, an online algorithm makes a sequence
  ...
  in the setting of contextual bandits, a natural extension of the basic MAB
  problem where before each round an algorithm is given the context – a hint
  ...
  is via a similarity distance between the context-arm pairs which bounds from
  ...
  adaptive partitions, and take advantage of “benign” payoffs and context arrivals
  ...
  MAB with constrained temporal change (Slivkins and Upfal, 2008) and sleeping bandits (Kleinberg et al., 2008a).
